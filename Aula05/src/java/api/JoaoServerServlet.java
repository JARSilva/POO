...
public class JoaoServerServlet extends HttpServlet {
    ...
    protected void processHtmlRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("<head><title>Date - Server API</title></head>");
        response.getWriter().println("<body>");
        response.getWriter().println("<h1>Server API</h1>");
        response.getWriter().println("<h2><a href='date.xml'  target='_blank'>date.xml</a></h2>");
        response.getWriter().println("<h2><a href='date.json' target='_blank'>date.json</a></h2>");
        response.getWriter().println("</body>");
        response.getWriter().println("</html>");
